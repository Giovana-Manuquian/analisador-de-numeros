...
function adicionar() {
    if(isNumero(num.value) && !inLista(num.value, valores)) {
        ...
        res.innerHTML = '' // quando conseguir adc um elemento, ele tem que limpar o resultado.
    } else {
        window.alert('Valor inválido ou já encontrado na lista.')
    }
    num.value = ''
    num.focus() // irá ficar disponível para inserir a mensagem, sem precisar ficar clicando toda hora.
}
